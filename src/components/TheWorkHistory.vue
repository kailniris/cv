<template>
  <v-card class="mt-4">
    <div class="pa-4">
      <h2 class="headline">Szakmai tapasztalat</h2>

      <div class="mt-4">
        <div class="subheading">2018. június - 2016. február</div>

        <h2 class="title mb-2">ANGRO Nagykereskedelmi Kft.</h2>
      ...
      <div class="mt-4">
        <div class="subheading">2016. január - 2015. augusztus</div>

        <h2 class="title mb-2">Roxin-Rocco Kft.</h2>
